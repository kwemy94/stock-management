...
import { addBuyCmd, getDataForCmd } from "../services/buy";
import { reference } from "@popperjs/core";
import "./buyStyle.css";

export default function BuyCommand({ type }) {
    // État de l’en-tête
    ...
    const handleSubmit = async (e, statut, another = false) => {
        ...
        setDisableBtn(true);
        try {
            const res = await addBuyCmd(invoiceData);
            console.log("save", res);
            if (res.status == 201) {
                toast.success(res.message || "Commande créer avec succès !!!");
                setForm({
                    client: null,
                    dateFacture: new Date().toISOString().slice(0, 10),
                    montantFacture: 0,
            ...
            <div className="row justify-content-center">
                <div className="col-xl-10 col-lg-11 col-md-12">
                    ...
                    <div className="mb-3 text-center">
                        <h5 className="mb-0 fw-semibold">Nouvelle commande</h5>
...
const container = document.getElementById("buy-command");
if (container) {
